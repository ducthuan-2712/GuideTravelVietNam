...
class LocalMap extends React.Component {
  ...
  componentWillReceiveProps(nextProps: Props) {
    if(this.props.callGoogleMap !== nextProps.callGoogleMap) {
      this.handleGetLink();
    }
  }
    ...
    return (
      <View style={[styles.container, this.props.style]}>
...

        {
          !this.props.types
            ? <BoxMarker
                ...
                onClose={this.handleCloseDataMaker}
...

        {
          this.state.coords
            ? <RoutesMap 
                style={styles.viewRoutes}
                routes={this.state.routesPlan}
                outLink={() => this.handleOutLink(this.state.dataMarker)}
                onClose={() => this.handleReturnMarker()}
              />
            : null
        }
