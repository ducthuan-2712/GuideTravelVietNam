...
const GPageControl = React.createClass({
  propTypes: {
...
module.exports = GPageControl;
module.exports.__cards__ = define => {
  define("Simple 2", () => <GPageControl count={2} selectedIndex={0} />);
  define("Simple 5", () => <GPageControl count={5} selectedIndex={2} />);
};
